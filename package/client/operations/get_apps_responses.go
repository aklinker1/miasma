...
func (o *GetAppsOK) Error() string {
	return fmt.Sprintf("[GET /api/apps][%d] getAppsOK  %+v", 200, o.Payload)
}
...
func (o *GetAppsDefault) Error() string {
	return fmt.Sprintf("[GET /api/apps][%d] getApps default  %+v", o._statusCode, o.Payload)
}

func (o *GetAppsDefault) GetPayload() string {
	return o.Payload
}
