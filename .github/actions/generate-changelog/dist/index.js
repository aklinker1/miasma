...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__export(__nccwpck_require__(16));
//# sourceMappingURL=index.js.map
...
module.exports = __nccwpck_require__(325)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(209);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(906);
} else {
...
try {
	...
	const supportsColor = __nccwpck_require__(363);
...
var init_util = __esm({
  "src/lib/utils/util.ts"() {
    import_file_exists = __nccwpck_require__(929);
    NULL = "\0";
    NOOP = () => {
    };
...
var init_git_logger = __esm({
  "src/lib/git-logger.ts"() {
    import_debug = __toESM(__nccwpck_require__(135));
    init_utils();
...
const core_1 = __nccwpck_require__(953);
const simple_git_1 = __nccwpck_require__(696);
...
// Utils
function getInputs() {
    const module = (0, core_1.getInput)("module");
    const message = (0, core_1.getInput)("message") || undefined;
    const scopes = (0, core_1.getInput)("scopes")
        .split(",")
        .map((scope) => scope.trim());
    return { module, message, scopes };
}
function setOutputs(changelog) {
    const changes = changelog.fixes.length +
        changelog.features.length +
        changelog.breakingChanges.length;
    if (changes === 0) {
        (0, core_1.setOutput)("changelog", "");
        (0, core_1.setOutput)("skipped", true);
        (0, core_1.setOutput)("nextVersion", "");
        return;
    }
    const lines = [];
    ...
    if (changelog.breakingChanges.length > 0) {
        lines.push("", "### BREAKING CHANGES", "", ...changelog.breakingChanges.reverse().map(formatCommit));
    }
    if (changelog.features.length > 0) {
        lines.push("", "### Features", "", ...changelog.features.reverse().map(formatCommit));
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const index_1 = __nccwpck_require__(891);
(0, index_1.generateChangelog)();
