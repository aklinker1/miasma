...
func (o *GetAppEnvURL) Build() (*url.URL, error) {
	...
	if appName != "" {
		...
		return nil, errors.New("appName is required on GetAppEnvURL")
	}
...
func (o *GetAppEnvURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAppEnvURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAppEnvURL")
	}
