...
func (o *InstallPluginURL) Build() (*url.URL, error) {
	...
	if pluginName != "" {
		...
		return nil, errors.New("pluginName is required on InstallPluginURL")
	}
...
func (o *InstallPluginURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on InstallPluginURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on InstallPluginURL")
	}
