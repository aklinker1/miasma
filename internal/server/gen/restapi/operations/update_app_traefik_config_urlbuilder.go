...
func (o *UpdateAppTraefikConfigURL) WithBasePath(bp string) *UpdateAppTraefikConfigURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateAppTraefikConfigURL) Build() (*url.URL, error) {
	...
	if appID != "" {
		...
		return nil, errors.New("appId is required on UpdateAppTraefikConfigURL")
	}
...
func (o *UpdateAppTraefikConfigURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateAppTraefikConfigURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateAppTraefikConfigURL")
	}
