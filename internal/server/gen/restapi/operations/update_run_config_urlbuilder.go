...
func (o *UpdateRunConfigURL) Build() (*url.URL, error) {
	...
	if appName != "" {
		...
		return nil, errors.New("appName is required on UpdateRunConfigURL")
	}
...
func (o *UpdateRunConfigURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateRunConfigURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateRunConfigURL")
	}
