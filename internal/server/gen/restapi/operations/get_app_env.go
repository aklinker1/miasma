...
func (fn GetAppEnvHandlerFunc) Handle(params GetAppEnvParams) middleware.Responder {
	return fn(params)
}
...
func NewGetAppEnv(ctx *middleware.Context, handler GetAppEnvHandler) *GetAppEnv {
	return &GetAppEnv{Context: ctx, Handler: handler}
}
