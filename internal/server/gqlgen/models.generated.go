...
func (ec *executionContext) marshalNLog2ᚕᚖgithubᚗcomᚋaklinker1ᚋmiasmaᚋinternalᚐLogᚄ(ctx context.Context, sel ast.SelectionSet, v []*internal.Log) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNLog2ᚖgithubᚗcomᚋaklinker1ᚋmiasmaᚋinternalᚐLog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
